	...
	<div id="page" class="site">
		...
		<header id="masthead" class="site-header c-header">
			<div class="c-header__main">
				...
				?>
					<p class="site-description"><?php echo $herbalapothecary_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
												?></p>
				<?php endif; ?>
			</div>

			<nav id="site-navigation" class="main-navigation c-navigation">
