				...
				foreach ($grouped_product_columns as $column_id) {
					...
					switch ($column_id) {
						case 'quantity':
							...
							// if (!$grouped_product_child->is_purchasable() || $grouped_product_child->has_options() || !$grouped_product_child->is_in_stock() || $grouped_product_child->is_sold_individually()) {
